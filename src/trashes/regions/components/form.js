...
const Form = ({ isUpdate, isSubmitting, setFieldValue, values, setCreateModal, setUpdateModal, isDistrict }) => {
	...
	return (
		<Grid.Row gutter={1}>
			<Grid.Column xs={12}>
				...
				{isDistrict && <Field component={Fields.Input} name="code" type="text" placeholder="Введите код" label="Код" />}
				<Field
