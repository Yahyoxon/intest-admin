...
const List = ({ history, location }) => {
	...
	const { page } = params;
	const moderator = useAccess({ roles: ["moderator"] });
						...
						<div className="page-container">
							<div className="pt-10">
								<Header
									title="Рейтинг"
									btnName="Добавить"
									hasButton={moderator ? false : true}
									btnClick={() => history.push(`/designer/create`)}
								/>
								<div className="tableColor-tr">
									<Table
										...
										isFetched={isFetched}
										editAction={value => history.push(`/designer/edit/${value.id}`)}
										hasMenuModal={moderator ? false : true}
										onRowClick={value => moderator && history.push(`/designer/edit/${value.id}`)}
										columns={[
											{
												title: "Имя компании",
												dataIndex: "name",
