...
const Form = ({ isUpdate, isSubmitting, setCreateModal, setUpdateModal, setFieldValue }) => {
	...
	return (
		<Grid.Row gutter={1}>
			<Grid.Column xs={12}>
				<Field component={Fields.Input} name="name_uz" type="text" placeholder="Введите название" label="Название(uz)" />
				<Field component={Fields.Input} name="name_ru" type="text" placeholder="Введите название" label="Название(ru)" />
				<Field component={Fields.Input} name="name_en" type="text" placeholder="Введите название" label="Название(en)" />
				{/* <Field
