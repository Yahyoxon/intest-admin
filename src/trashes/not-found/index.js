        ...
        <div className="container">
            <div className="error-page flex flex-col lg:flex-row items-center justify-center h-screen text-center lg:text-left">
                <div className="-intro-x lg:mr-20">
                    <img alt="OKS ADMIN PANEL" className="h-48 lg:h-auto" src={require('assets/images/error-illustration.svg')} />
                </div>
                <div className="text-white mt-10 lg:mt-0">
                    ...
                    <button className="intro-x btn py-3 px-4 text-white border-white dark:border-dark-5 dark:text-gray-300 mt-10">Back to Home</button>
                </div>
            </div>
        </div>
    )
